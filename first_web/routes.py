...
from first_web import app, bcrypt, db
from first_web.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm
from first_web.model import User, Post
...
def candidates():
    ...
    return render_template('candidates.html', title='Aspirants Section', posts=posts)

@app.route("/exams")
def exams():
    return render_template('exams.html', title='Exams')
...
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(user)
        db.session.commit()
        flash(f'Account has been created now you can login', 'success')
